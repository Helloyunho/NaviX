...
struct H2Tag: BodyTagProtocol {
    ...
    var body: some View {
        Text(_children.joined(separator: " "))
            ...
            .modifier(CSSRuleSet.CSSFontModifier(ruleSet: style, defaultFontSize: 22, defaultFontWeight: .bold))
            .applyCommonCSS(ruleSet: style, tag: self)
    }

    static func parse(_ elem: Element, html: @escaping HTMLGetter) throws -> H2Tag {
